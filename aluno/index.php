...
<body>
    <div class="container">
        ...
        <p>Bem-vindo, Aluno!</p>
        <a href="matricula.php">Matrícula em Cursos</a><br>
        <a href="notas.php">Consultar Notas</a><br>
        <a href="documentos.php">Solicitar Documentos</a><br>
        <a href="atendimento.php">Agendar Atendimento</a><br>
